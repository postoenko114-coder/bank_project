...
import com.example.demo.services.account.AccountServiceImpl;
...
public class AccountServiceTest {
    ...
    void deposit_ShouldReturnTransaction_WhenAccountIsActive() {
        ...
        Transaction result = accountServiceImpl.deposit(1L, BigDecimal.valueOf(200));
    ...
    void withdrawal_ShouldReturnTransaction_WhenAccountIsActiveAndHasSufficientFunds() {
        ...
        Transaction result = accountServiceImpl.withdrawal(1L, BigDecimal.valueOf(200));
    ...
    void transfer_ShouldReturnTransaction_WhenBothAccountsAreActiveAndFundsAreSufficient() {
        ...
        Transaction result = accountServiceImpl.transfer(1L, 2L, BigDecimal.valueOf(300), "Test transfer");
    ...
    void payByCard_ShouldReturnTransaction_WhenAccountIsActiveAndFundsAreSufficient() {
        ...
        Transaction result = accountServiceImpl.payByCard(1L, BigDecimal.valueOf(100));
