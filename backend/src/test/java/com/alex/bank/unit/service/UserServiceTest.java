...
import com.alex.bank.services.user.UserServiceImpl;
...
public class UserServiceTest {
    ...
    void findUserByUsername_ShouldReturnUser_WhenUserExists() {
        ...
        UserDTO result = userServiceImpl.findUserByUsername(fakeUser.getUsername());
    ...
    void findUserByEmail_ShouldReturnUser_WhenUserExists() {
        ...
        UserDTO result = userServiceImpl.findUserByEmail(fakeUser.getEmail());
