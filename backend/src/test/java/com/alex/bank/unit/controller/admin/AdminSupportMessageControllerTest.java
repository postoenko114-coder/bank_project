...
import com.alex.bank.controllers.admin.AdminSupportMessageController;
...
public class AdminSupportMessageControllerTest {
    ...
    void replyToMessage_ShouldSendNotification_WhenUserIsRegistered() throws Exception {
        ...
        verify(notificationService).createAndSendNotification(eq(1L), eq(TypeNotification.SUPPORT), anyString());
    ...
    void replyToMessage_ShouldSendEmail_WhenUserIsNotRegistered() throws Exception {
        ...
        verify(notificationService, never()).createAndSendNotification(anyLong(), any(), anyString());
    }
