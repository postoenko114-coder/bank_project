...
import com.alex.bank.controllers.client.TransactionController;
...
public class TransactionControllerTest {
    ...
    private TransactionDetailsDTO buildTransactionDetailsDTO(Long id, TypeTransaction type, BigDecimal amount) {
        String fakeAccount = ("123456789/0001");
    ...
    void getUserTransactions_ShouldReturnTransactionDTOList_WhenUserExists() throws Exception {
        TransactionDetailsDTO t1 = buildTransactionDetailsDTO(1L, TypeTransaction.DEPOSIT, BigDecimal.valueOf(100));
        TransactionDetailsDTO t2 = buildTransactionDetailsDTO(2L, TypeTransaction.WITHDRAWAL, BigDecimal.valueOf(50));
    ...
    void getTransaction_ShouldReturnTransactionDTO_WhenTransactionExists() throws Exception {
        TransactionDetailsDTO fakeTransaction = buildTransactionDetailsDTO(1L, TypeTransaction.DEPOSIT, BigDecimal.valueOf(200));
    ...
    void getTransaction_ShouldReturn400_WhenTransactionIsHidden() throws Exception {
        TransactionDetailsDTO hiddenTransaction = buildTransactionDetailsDTO(1L, TypeTransaction.WITHDRAWAL, BigDecimal.valueOf(100));
    ...
    void getTransactionsAfterDate_ShouldReturnFilteredTransactions() throws Exception {
        TransactionDetailsDTO t1 = buildTransactionDetailsDTO(1L, TypeTransaction.WITHDRAWAL, BigDecimal.valueOf(50));
    ...
    void getTransactionsBeforeDate_ShouldReturnFilteredTransactions() throws Exception {
        TransactionDetailsDTO t1 = buildTransactionDetailsDTO(1L, TypeTransaction.TRANSFER, BigDecimal.valueOf(300));
